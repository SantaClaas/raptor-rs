...
use crate::sql::create_tables_queries::{
    CREATE_AGENCIES_QUERY, CREATE_AREAS_QUERY, CREATE_ATTRIBUTIONS_QUERY,
    CREATE_CALENDAR_DATES_QUERY, CREATE_CALENDAR_QUERY, CREATE_FARE_ATTRIBUTES_QUERY,
    CREATE_FARE_LEG_RULES_QUERY, CREATE_FARE_MEDIA_QUERY, CREATE_FARE_PRODUCTS_QUERY,
    CREATE_FARE_RULES_QUERY, CREATE_FARE_TRANSFER_RULES_QUERY, CREATE_FEED_INFO_QUERY,
    CREATE_FREQUENCIES_QUERY, CREATE_LEVELS_QUERY, CREATE_PATHWAYS_QUERY, CREATE_ROUTES_QUERY,
    CREATE_SHAPES_QUERY, CREATE_STOPS_QUERY, CREATE_STOP_AREAS_QUERY, CREATE_STOP_TIMES_QUERY,
